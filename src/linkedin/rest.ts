...
export class RestLinkedIn implements LinkedInClient {
  async getOrgUrnFromVanity(vanity: string) {
  ...
  async getCommenters(postUrn: string, count = 100) {
